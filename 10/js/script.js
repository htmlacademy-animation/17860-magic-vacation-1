...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils */ "./source/js/utils/index.js");
...
/* harmony default export */ __webpack_exports__["default"] = (() => {
  ...
  document.body.addEventListener(`screenChanged`, async (e) => {
    ...
    if (screenName === `prizes` && !animationsCompleted) {
      ...
      await Object(_utils__WEBPACK_IMPORTED_MODULE_0__["sleep"])(350);
      ...
      for (const {url, duration, elementId} of svgsMap) {
        ...
        await Object(_utils__WEBPACK_IMPORTED_MODULE_0__["sleep"])(duration);
      }
...
/* harmony import */ var _modules_prizes_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/prizes.js */ "./source/js/modules/prizes.js");
...
/* harmony import */ var _modules_typography__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/typography */ "./source/js/modules/typography.js");
// modules
...
Object(_modules_prizes_js__WEBPACK_IMPORTED_MODULE_8__["default"])();

const fullPageScroll = new _modules_full_page_scroll__WEBPACK_IMPORTED_MODULE_9__["default"]();
const titleAnimator = new _modules_typography__WEBPACK_IMPORTED_MODULE_11__["default"](`.intro__title`, 350, `active`, `transform`, `cubic-bezier(0.1, 0.53, 0.32, 0.98)`, 750);
const dateAnimator = new _modules_typography__WEBPACK_IMPORTED_MODULE_11__["default"](`.intro__date`, 350, `active`, `transform`, `cubic-bezier(0.1, 0.53, 0.32, 0.98)`, 1150);
fullPageScroll.init();
